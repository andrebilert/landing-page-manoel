...
# Batch 3 Images (uploaded previously)
batch3_images = [
...
# Batch 4 Images (uploaded just now)
batch4_images = [
...
all_images = batch3_images + batch4_images
output_dir = "public/assets/festas"
os.makedirs(output_dir, exist_ok=True)

# Start index from 11 since we already have 10 images (formaturas-1..5, festas-6..10)
start_index = 11
