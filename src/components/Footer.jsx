            ...
            <div className="container">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
                    <div className="md:col-span-2">
                        <h3 className="text-2xl font-bold mb-4 text-[var(--color-text)]">HMARCIANO</h3>
                    ...
                    <div>
                        <h4 className="font-bold mb-4 text-[var(--color-text)]">Contato</h4>
                    ...
                    <div>
                        <h4 className="font-bold mb-4 text-[var(--color-text)]">Redes Sociais</h4>
